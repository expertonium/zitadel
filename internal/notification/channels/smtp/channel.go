...
func (email *Email) HandleMessage(message channels.Message) error {
	if email.httpRelayClient != nil {
		...
		if !ok {
			return zerrors.ThrowInternal(nil, "EMAIL-proxy1", "message is not EmailMessage")
		}
		...
		if err != nil {
			return zerrors.ThrowInternalf(nil, "EMAIL-proxy2", "could not marshal json")
		}
		...
		if err != nil {
			return zerrors.ThrowInternalf(nil, "EMAIL-proxy3", "could not create request: "+err.Error())
		}
		...
		if err != nil {
			return zerrors.ThrowInternalf(nil, "EMAIL-proxy4", "error making request: "+err.Error())
		}
		return nil
	}
